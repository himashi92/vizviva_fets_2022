...
from dataset.brats import get_test_datasets
from crswin2.vision_transformer import VTUNet as ViT_seg
from utils import reload_ckpt_bis, \
    count_parameters, generate_segmentations_monai_test

parser = argparse.ArgumentParser(description='CR-SWIN2-VT BRATS 2021 Inference')
...
def main(args):
    ...
    args.checkpoint = args.save_folder_1 / "cr_swin_2.pth.tar"
    ...
    bench_dataset = get_test_datasets()
    ...
    generate_segmentations_monai_test(bench_loader, model_1, t_writer_1, args)
